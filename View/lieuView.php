...
foreach ($listeLieu as $donnees) {
    ...
    echo "<a class='btn btn-primary'  href='".BASE_URL."/lieu/".$donnees['NomLieu']."/update'>Modifier</a> &nbsp";
    echo "<a class='btn btn-primary' href='".BASE_URL."/lieu/".$donnees['NomLieu']."/delete'>Supprimer</a>";
    echo "</div>";
    echo "</div>";

}
    echo "<button value='ajouter'><a class='btn btn-primary' href='".BASE_URL."/lieu/add'>Ajouter</a></button>";